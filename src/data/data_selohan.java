 ...
 * @author User
 */
public class data_selohan extends javax.swing.JFrame {
    ...
    public void datatable() {DefaultTableModel tbl= new DefaultTableModel();
        ...
        try{
            ...
            ResultSet res=statement.executeQuery("select * from selohan");
            while (res.next())
            {
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Dusun Selohan, Desa Capang - Purwodadi");
    ...
    private void btSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSimpanActionPerformed
       String no = txNomor.getText();
        ...
        try{
            Statement statement = (Statement) koneksi.GetConnection().createStatement();
            statement.executeUpdate("insert into selohan VALUES ('"+ no +"','"+ nama +"','"+ rt_rw +"','"+ status +"','"+tahun+"','"+pekerjaan+"','"+lembaga+"','"+jurusan+"','"+no_tlp+"');");
            statement.close();
    ...
    private void bthapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bthapusActionPerformed
      String no = txNomor.getText();
        try {
            ...
            if(statement.executeUpdate("DELETE from selohan where no = ('"+ no +"');")==1){
             }else{
    ...
    private void btCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCariActionPerformed
        try{
            Statement statement=(Statement) koneksi.GetConnection().createStatement();
            ResultSet res = statement.executeQuery("select * from selohan where "+"no='"+txNomor.getText()+"'");
...
//        }
        ...
        try{
            ...
            String filetoFill="./src/Report/print_selohan.jasper";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(data_selohan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new data_selohan().setVisible(true);
            }
        });
    }
