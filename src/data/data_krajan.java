 ...
 * @author User
 */
public class data_krajan extends javax.swing.JFrame {
    ...
    public void datatable() {DefaultTableModel tbl= new DefaultTableModel();
        ...
        try{
            ...
            ResultSet res=statement.executeQuery("select * from krajan");
            while (res.next())
            {
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Dusun Krajan, Desa Capang - Purwodadi");
    ...
    private void btSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSimpanActionPerformed
       String no = txNomor.getText();
        ...
        try{
            Statement statement = (Statement) koneksi.GetConnection().createStatement();
            statement.executeUpdate("insert into krajan VALUES ('"+ no +"','"+ nama +"','"+ rt_rw +"','"+ status +"','"+tahun+"','"+pekerjaan+"','"+lembaga+"','"+jurusan+"','"+no_tlp+"');");
            statement.close();
    ...
    private void bthapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bthapusActionPerformed
      String no = txNomor.getText();
        try {
            ...
            if(statement.executeUpdate("DELETE from krajan where no = ('"+ no +"');")==1){
             }else{
    ...
    private void btCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCariActionPerformed
        try{
            Statement statement=(Statement) koneksi.GetConnection().createStatement();
            ResultSet res = statement.executeQuery("select * from krajan where "+"no='"+txNomor.getText()+"'");
...
//        }
        ...
        try{
            ...
            String filetoFill="./src/Report/print_krajan.jasper";
...
//            
//            String path = ".\\scr/Report?print_krajan.jasper";
//        try {
//            reports = (JasperReport) JRLoader.loadObjectFromFile(path);
//            
//            JasperPrint jprint = JasperFillManager.fillReport(path, null, con);
//            JasperViewer jviewer = JasperViewer(jprint, false);
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(data_krajan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new data_krajan().setVisible(true);
            }
        });
    }
