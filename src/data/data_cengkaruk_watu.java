 ...
 * @author User
 */
public class data_cengkaruk_watu extends javax.swing.JFrame {

    /**
     * Creates new form insert_data
     */
    public data_cengkaruk_watu() {
        initComponents();
        datatable();
    }
    ...
    public void datatable() {DefaultTableModel tbl= new DefaultTableModel();
        ...
        try{
            ...
            ResultSet res=statement.executeQuery("select * from cengkaruk_watu");
            while (res.next())
            {
    ...
    private void btSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSimpanActionPerformed
       String no = txNomor.getText();
        ...
        try{
            Statement statement = (Statement) koneksi.GetConnection().createStatement();
            statement.executeUpdate("insert into cengkaruk_watu VALUES ('"+ no +"','"+ nama +"','"+ rt_rw +"','"+ status +"','"+tahun+"','"+pekerjaan+"','"+lembaga+"','"+jurusan+"','"+no_tlp+"');");
            statement.close();
    ...
    private void bthapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bthapusActionPerformed
      String no = txNomor.getText();
        try {
            ...
            if(statement.executeUpdate("DELETE from cengkaruk_watu where no = ('"+ no +"');")==1){
             }else{
    ...
    private void btCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCariActionPerformed
        try{
            Statement statement=(Statement) koneksi.GetConnection().createStatement();
            ResultSet res = statement.executeQuery("select * from cengkaruk_watu where "+"no='"+txNomor.getText()+"'");
...
//        }
        ...
        try{
            ...
            String filetoFill="./src/Report/print_cengkaruk_watu.jasper";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(data_cengkaruk_watu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new data_cengkaruk_watu().setVisible(true);
            }
        });
    }
